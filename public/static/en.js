export const en = {
  ...
  //Services Features
  services_FeaturesHeading: "features",
  services_FeaturesFirstpara:
    "White Label Service (the Customer uses the Rafiky platform while maintaining his own brand/logo)",
  services_FeaturesSecpara:
    "Reporting (possibility of creating statistics and analysis at the end of the event)",
  services_FeaturesThirdpara: "Free service",
  services_FeaturesForthpara:
    "Moderator-Technical support available during the entire duration of the event with audio/video direction",
  services_FeaturesFivepara: "Video and Audio of the highest quality",
  services_Featuressixtpara:
    "Streaming on social media platforms or third-party sites",
  services_Featuressevenpara:
    "Unlimited number of participants/languages/speakers",
  services_FeaturesEightpara:
    "Chat rooms available according to customer needs (Single or Multiple, Private or public)",
  services_FeaturesNinepara: "Possibility of screen sharing",
  services_FeaturesTenpara: "and so on! Put us to the test.",
  services_FeaturesElevenpara:
    "Platform available for any type of hardware (PC/Tablet/Smartphone)",
  services_FeaturesTwelvepara:
    "Cloud recording Complete recording of the event with final post-editing",
  services_FeaturesTherteenpara: "Q/A Online voting system",
  //Services Remote
  ...
  serviceschooseRafiky_Firstcardpara:
    "• Multilingual meeting with foreign partners remote simultaneous interpreting. • Multilingual meeting with foreign partners remote simultaneous interpreting.• Multilingual meeting with foreign partners remote simultaneous interpreting.",
  serviceschooseRafiky_SeccardTitle: "INNOVATIVE VISION",
  serviceschooseRafiky_Seccardpara:
    "• 50% savings on technical equipment (no booth needed). • Ideal for rooms where the installation of booths is not possible/requires greater efforts and costs. • Audio-video direction and on-site technical assistance. Availability in more than 200 languages.",
  serviceschooseRafiky_ThirdcardTitle: "Webinars",
  serviceschooseRafiky_Thirdcardpara:
    "• Ease of presenting content on your screen. • Video streams. • Several rooms for each conference with fragmentation of topics. Availability in more than 200 languages.",
  serviceschooseRafiky_ForthcardTitle: "Press conferences",
  serviceschooseRafiky_Forthcardpara:
    "• Wide choice of location for speakers and participants. • Global participation. • Moderation of journalists' questions. Availability in more than 200 languages.",
  ...
  teamsIntegration_Seccard_Heading: "SIMPLE SOLUTION",
  teamsIntegration_Seccard_para:
    "Continue to use your favorite platform by integrating the Remote Interpreting Service with Rafiky. No transition costs!",
  teamsIntegration_Thirdcard_Heading: "0 SWITCHING COSTS",
  teamsIntegration_Thirdcard_para:
    "Continue to use your favorite platform by integrating the Remote Interpreting Service with Rafiky. No transition costs!",
  teamsIntegration_Forthcard_Heading: "SAVINGS",
  teamsIntegration_Forthcard_para:
    "Continue to use your favorite platform by integrating the Remote Interpreting Service with Rafiky. No transition costs!",
  teamsIntegration_Fifthcard_Heading: "PRE-EVENT TEST",
  teamsIntegration_Fifthcard_para:
    "Continue to use your favorite platform by integrating the Remote Interpreting Service with Rafiky. No transition costs!",
  teamsIntegration_Sixthcard_Heading: "TECHNICAL SUPPORT",
  teamsIntegration_Sixthcard_para:
    "Continue to use your favorite platform by integrating the Remote Interpreting Service with Rafiky. No transition costs!",
  teamsIntegration_Seventhcard_Heading: "INNOVATIVE VISION",
  teamsIntegration_Seventhcard_para:
    "Continue to use your favorite platform by integrating the Remote Interpreting Service with Rafiky. No transition costs!",
  ...
  //Remote Interpreting
  remoteInterpreting_Heading: "Remote interpreting service Rafiky XP",
  remoteInterpreting_para:
    "Whether it's promoting activities or products conducting interviews holding workshops webinars or online courses organizing an online event is not easy at all. It will be necessary to define objectives and strategies create work plans agendas and questionnaires take care of the collateral marketing and management of the participants without neglecting the purely technical part. The team of our remote interpreting agency will take care of every aspect of your online event for a unique all-round experience.",
  ...
  zonessDifference_FirstHeading: "zonessDifference",
  ...
  //Interpretation Services
  interpretationServices_Heading: "Interpretation services in Chinese and Lis",
  interpretationServices_para:
  ...
  estimateRates_para:
    "More than 30'000 events realized Over 200 languages available 6'000 Professional Interpreters!",
  ...
  doBest_FirstSubHeading: "Organization",
  doBest_SecSubHeading: "Support material",
  doBest_ThirdSubHeading: "Interpreter skills ",
  doBest_ForthSubHeading: "Team training",
  doBest_FivethSubHeading: "Analytical",
  doBest_SixSubHeading: "Web development",
  doBest_SevenSubHeading: "Feedback",
  doBest_Btn: "QUOTE REQUEST",
  //Our Skills
  ourSkills_Heading: "Our skills",
  ourSkills_FirstCardHeading: "Planning",
  ourSkills_FirstCardDescription: "Our team has more than 10 years of experience in event planning. We will take care of every detail",
  ourSkills_SecCardHeading: "Software",
  ourSkills_SecCardDescription: "Our platform is ISO 9241 certified. User friendly and super efficient",
  ourSkills_ThirdCardHeading: "Feedback",
  ourSkills_ThirdCardDescription: "We are available 24 hours a day. We offer free preventive services in a very short time.",
  ourSkills_ForthCardHeadingpara: "Technical Support",
  ourSkills_ForthCardHeadingDescription: "We guarantee advice and technical support throughout the event.",
  ...
  remoteVideo_para:
    "Remote video interpreting offers the assistance of an online interpreter in any language and in real time. It will not be necessary to have one or more interpreters on site or the cumbersome equipment that has characterized the world of traditional interpreting until today. By reducing or sometimes even eliminating audio and video equipment costs our remote interpreting service provides a quality service unrivaled on today's market. Remote interpreting is ideal for any type of international meeting or event. And if the quality of the video interpreted remotely is top notch and the audio crystal clear a few simple steps will be enough to create a successful event. The application combines the power of cloud technology with modern devices to facilitate the interpretation technique: this type of process allows everyone to communicate simply taking advantage of remote simultaneous interpretation via smartphone tablet or computer. The application is intuitive powerful and free of bugs or glitches responsible for interference in the communication process; it works for any type of meeting or event with any language and in real time guaranteeing the excellence of an always quality service just like in traditional interpreting but without the cumbersome translation booths and the related assembly/disassembly costs and times necessary. All you need is a device (PC laptop or smartphone) with a good Internet connection to take advantage of a professional interpreting service with immediate communication between interlocutors of different languages. A network of online interpreters will help you handle any kind of emergency!",
  ...
  microsoftTeams_para:
    "To organize a successful conference it is not always necessary to use technical equipment or the presence of professional interpreters on site. Thanks to our revolutionary simultaneous translation cloud platform we are in a position to connect users in real time and from anywhere in the world eliminating time and costs related to technical equipment means and travel but guaranteeing the quality of a professional interpreting service. Unlike traditional simultaneous interpreting our remote simultaneous interpreting allows interpreters speakers and listeners to interact remotely via smartphone tablet or computer. If you choose to organize a conference remotely the best professional interpreters will be able to provide quality interpreting service from your workplace at any time while guests follow the conference remotely. This will eliminate the cost and time of traditional interpreting enabling even wider participation.",
  ...
  microsoftTeams_Firstcardpara:
    "Trust Rafiky for your conference thanks to our technology we offer a fast and convenient service which guarantees the best experience for the participants without the need for bulky booths in the room.",
  microsoftTeams_SeccardHeading: "PRESS CONFERENCES",
  microsoftTeams_Seccardpara:
    "With Rafiky's platform you can offer professional simultaneous interpreting during your press conference for as many languages as you want without having to order booths or book interpreters in advance. All it takes is a few hours notice.",
  microsoftTeams_ThirdHeading: "WEBINARS",
  microsoftTeams_Thirdpara:
    "Rafiky offers the user the possibility to increase the audience of webinars with a multilingual audience. All participants will be able to interact without communication difficulties during the event: it is this type of flexibility that makes Rafiky unique in its kind.",
  microsoftTeams_ForthHeading: "WORKSHOPS & TRAININGS",
  microsoftTeams_Forthpara:
    "With the use of Rafiky you will find that any workshop training can be offered to an international audience. Live translations are made easy with this powerful application.!",
  microsoftTeams_FiveHeading: "CORPORATE MEETINGS",
  microsoftTeams_Fivepara:
    "There is nothing more frustrating for executives than facing language barriers during company meetings. Communicating with ease on these occasions is essential: thanks to the use of Rafiky communication difficulties will be just a thing of the past!",
  microsoftTeams_SixHeading: "ONLINE MEETINGS",
  microsoftTeams_Sixpara:
    "Last minute online meetings and video conferences? Rafiky was designed for this! Thanks to remote interpreting the best remote interpreters will be connected to speakers and participants in real time.",
  microsoftTeams_SevenHeading: "MUSEUMS & TOURS",
  microsoftTeams_Sevenpara:
    "For visits to museums or for any type of tour, each participant will be able to connect to Rafiky and receive live interpretation: in this way no one will feel excluded during the tour which will thus become a pleasant opportunity for sharing.",
  microsoftTeams_EightHeading: "EXHIBITIONS AND FAIRS",
  microsoftTeams_Eightpara:
    "Are you attending a trade show in a foreign country or hosting an exhibition? Even for this type of need Rafiky is the most functional and… pocket-sized solution!",
