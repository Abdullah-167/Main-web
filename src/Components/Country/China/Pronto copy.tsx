...
import BgImage from '../../../../public/blue-bg.webp'
        ...
        <div className='main-cpmBg py-10'
            ...
            <div className='container'>
                <div>
                    ...
                    <div>
                        <h5 className='text-2xl text-white font-bold text-center pt-10 pb-8 leading-1'>INIZIAMO</h5>
                        <h2 className='text-[35px] sm:text-[50px] text-white font-bold text-center mx-auto pb-12 max-w-[950px]'>Pronti a fare un vero cambiamento? Affrontiamolo insieme!</h2>
                    </div>
