        ...
        <div className='main-cpmBg py-10'
            ...
            <div className='container'>
                <div>
                    ...
                    <div>
                        <h2 className='text-[35px] sm:text-[50px] text-white font-bold text-center mx-auto pb-12 max-w-[950px]'>{t("serviceschooseRafiky_SecTitle")}</h2>
                    </div>

                    <div className='flex justify-center'>
                        <Button text={t("serviceschooseRafiky_Btn")} color={'black'} backgroundColor={'white'} minWidth={undefined} />
                    </div>
                </div>
