    ...
    return (
        <div className='sm:py-32'>
            <div className='container'>
                <h2 className='text-center text-6xl font-medium pb-16'>More Services</h2>
...
const cards = [
    {
        icon: <TbPinnedFilled />,
        heading: 'Video Web Conferencings',
    ...
    {
        icon: <BsFillPeopleFill />,
        heading: 'Interpretation Services',
        bgColor: '#E09900',
        color: '#F0B800'
    }, {
        icon: <FaArrowsAlt />,
        heading: 'Interpretation Agency',
        bgColor: '#FECECE',
        color: '#E02B20'
    }, {
        icon: <HiSpeakerWave />,
        heading: 'Remote Interpreters',
        bgColor: '#D5F0C6',
        color: '#76CE44'
    },
