      ...
      <div className="container">
        <div className="flex justify-center items-center gap-10">
          <div className="py-20 sm:py-32">
            <div className="mb-12">
              <p className="text-base sm:text-[30px] font-medium text-white mx-auto max-w-[750px] text-center leading-9 pb-4">
                {" "}
                {t("servicesRemoteinterpreting_Title")}
              </p>
              <h2 className="text-[30px] sm:text-[60px] md:text-[79px] text-white font-bold mx-auto max-w-[1100px] text-center leading-[1.2em] pb-12">
